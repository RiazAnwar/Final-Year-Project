<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Design_project.Login" %>
...
<div >
            <table align="center" Class="tablelogindesign" runat="server" >
               <caption><h3>Login Form</h3></caption>
                ...
                <tr>
                    <td>
                        <a href="Appointments.aspx">Appointments.aspx</a>
                    </td>
                </tr>
            </table>
        </div>
