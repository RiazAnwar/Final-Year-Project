<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="PatientRecord.aspx.cs" Inherits="Design_project.PatientRecord" %>
          ...
          <div>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownListpatienttype"  runat="server">
                           <asp:ListItem Text="--Patient Type--" value="-1"></asp:ListItem>
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownListmarry"  runat="server">
                            <asp:ListItem Text="--Martial Status--" value="-1"></asp:ListItem>
                 ...
                 <tr>
                    ...
                    <td>
                        ...
                        <asp:CompareValidator ID="CompareValidatorcnic" runat="server" 
                            ErrorMessage="Must be Integer" ControlToValidate="txtcnic"
                  ...
                  <tr>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorcontact" runat="server" 
                            ErrorMessage="contact is required"  ControlToValidate="txtcontact"  
                            ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
            ...
            <tr>
                    ...
                    <td>
                        ...
                        <asp:Button Text="Delete Patient" ID="btndeletepatient" runat="server" OnClick="btndeletepatient_Click"  Width="111px" Height="39px"  Font-Size="XX-Small"/>
              ...
              <div style="overflow: scroll; width: 588px;">
