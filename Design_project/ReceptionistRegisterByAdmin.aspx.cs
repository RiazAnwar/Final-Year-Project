...
{
    public partial class ReceptionistRegisterByAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (!String.IsNullOrEmpty(Request.QueryString["id"]))
                {
                    ...
                    {
                        sqlcon.Open();
                        SqlDataAdapter sqlda = new SqlDataAdapter("ReceptionistUserViewByID", sqlcon);
                        ...
                        DropDownListGender.Items.FindByValue(dtbl.Rows[0][4].ToString()).Selected = true;
                        txtaddress.Text = dtbl.Rows[0][5].ToString();
                        txtusername.Text = dtbl.Rows[0][6].ToString();
                        txtpwd.Text = dtbl.Rows[0][7].ToString();
                        txtpwd.Attributes.Add("value", dtbl.Rows[0][7].ToString());
                        txtconfirmpwd.Text = dtbl.Rows[0][7].ToString();
                        txtconfirmpwd.Attributes.Add("value", dtbl.Rows[0][7].ToString());
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("ReceptionistUserAddorEdit", con);
        ...
        void Clear()
        {
            txtfname.Text = txtlname.Text = txtcontact.Text = txtaddress.Text = txtusername.Text = txtpwd.Text = txtconfirmpwd.Text = "";
            hfuserID.Value = "";
